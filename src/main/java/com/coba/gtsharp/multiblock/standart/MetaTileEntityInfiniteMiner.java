...
import com.coba.gtsharp.api.capability.impl.miner.GTSharpMultiblockMinerLogic;
...
public class MetaTileEntityInfiniteMiner extends MultiblockWithDisplayBase
    ...
    private final GTSharpMultiblockMinerLogic minerLogic;

    public MetaTileEntityInfiniteMiner(ResourceLocation metaTileEntityId, int tier, int speed, int maximumChunkDiameter,
                                       int fortune, Material material, int drillingFluidConsumePerTick) {
        super(metaTileEntityId);
        this.material = material;
        this.tier = tier;
        this.drillingFluidConsumePerTick = drillingFluidConsumePerTick;
        this.minerLogic = new GTSharpMultiblockMinerLogic(this, fortune, speed, maximumChunkDiameter * CHUNK_LENGTH / 2,
                RecipeMaps.MACERATOR_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityInfiniteMiner(metaTileEntityId, this.tier, this.minerLogic.getSpeed(),
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('X', states(getCasingState())
                        ...
                        .or(dataHatchPredicate().setMaxGlobalLimited(1).setPreviewCount(1))
                        .setPreviewCount(1)))
