package com.coba.gtsharp.api.metatileentity.multiblock;
...
public abstract class GTSharpMultiblockWithDisplayBase extends MultiblockControllerBase implements IMaintenance {
    ...
    public GTSharpMultiblockWithDisplayBase(ResourceLocation metaTileEntityId) {
        ...
        if (shouldShowVoidingModeButton()) {
            builder.widget(new ImageCycleButtonWidget(173, 161, 18, 18, GuiTextures.BUTTON_VOID_MULTIBLOCK,
                    4, this::getVoidingMode, this::setVoidingMode)
                            .setTooltipHoverString(GTSharpMultiblockWithDisplayBase::getVoidingModeTooltip));
        } else {
     ...
     * Prioritized over any warnings provided by {@link GTSharpMultiblockWithDisplayBase#addWarningText}.
     */
