...
public class GTSharpMultiblockMinerLogic extends GTSharpMinerLogic {
     ...
     */
    public GTSharpMultiblockMinerLogic(MetaTileEntity metaTileEntity, int fortune, int speed, int maximumRadius,
