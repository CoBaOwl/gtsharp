...
public class GTSharpMinerLogic {
    ...
    private List<OreDepositDefinition> GENERATION = new LinkedList<>();
     ...
     */
    public GTSharpMinerLogic(@NotNull MetaTileEntity metaTileEntity, int fortune, int speed, int maximumRadius,
    ...
    public void performMining() {
        ...
        var a = WorldGenRegistry.getNamedDimensions();
     ...
     */
    private static boolean checkCoordinatesInvalid(@NotNull AtomicInteger x, @NotNull AtomicInteger y,
                                                   @NotNull AtomicInteger z) {
